                ...
                {items.map((item) => (
                    <li key={item.number}>
                        <details className="group">
                            <summary className="cursor-pointer select-none rounded px-1.5 py-1 text-sm text-foreground marker:text-amber-400/70 hover:bg-amber-500/10">
                                <span className="mr-1.5 font-mono text-xs text-amber-300">
                                    {item.number}.
                                </span>
